...
public class CustomerController {
	...
	final private List<Customer> customers = List.of(
			Customer.builder().id("001").name("Nguyễn Quốc Bảo").phoneNumber("0362389623")
					.email("bao26sv@gmail.com").build(),
			Customer.builder().id("002").name("User").email("bao26@gmail.com").build());
